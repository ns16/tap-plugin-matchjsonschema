...
export const load: LoadHook = async (url, context, nextLoad) => nextLoad(url, context)

export const resolve: ResolveHook = async (url, context, nextResolve) => nextResolve(url, context)
